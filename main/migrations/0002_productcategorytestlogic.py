# Generated by Django 3.2.18 on 2023-04-06 10:47
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='ProductCategoryTestLogic',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('FeatureName', models.CharField(max_length=200)),
                ('FeatureDesc', models.CharField(max_length=1000)),
                ('FeatureWeight', models.IntegerField()),
                ('FeatureScore', models.IntegerField()),
